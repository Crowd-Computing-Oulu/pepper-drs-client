...
public class Conversation {
    ...
    public String respondTo(String input) {
        ...
        LOG.debug(this.getClass().getSimpleName(), "Getting response from ChatGPT...");
        ChatCompletionRequest chatCompletionRequest = ChatCompletionRequest.builder()
                ...
                .build();
        LOG.debug(this.getClass().getSimpleName(), "Received response from ChatGPT!");
    ...
    */
        ...
        list.add(new ChatMessage(systemName, "Your name is Pepper, a friendly and professional humanoid social robot speaking to a human (H).You are deployed at the University of Oulu in Finland.Your purpose is to help students, academic staff and visitors.You can talk about the university: people, facilities and locations.You always respond in a very concise manner, at most 20 words. You do not comment on your abilities. You stay in the role of Pepper and speak in very brief words and sentences."));
        return list;
    }

    public int length() {
        return convHist.size();
    }
}
